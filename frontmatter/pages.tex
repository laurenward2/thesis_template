...
\newgeometry{left=1.25in,right=1.25in,bottom=1in,nohead}
...
\renewcommand*{\thepage}{\hbox{}\hspace{-0.25in}\roman{page}}
...
\renewcommand*{\thepage}{\hbox{}\hspace{-0.25in}\arabic{page}}
